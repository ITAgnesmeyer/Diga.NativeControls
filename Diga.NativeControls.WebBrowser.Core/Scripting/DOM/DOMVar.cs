...
namespace Diga.NativeControls.WebBrowser.Scripting.DOM
{
    ...
    public class DOMVar : ScriptObjectBase, IDisposable
    {
        ...
        public static async Task<DOMVar> CreateAsync(NativeWebBrowser control)
        {
        ...
        internal DOMVar(NativeWebBrowser control) : this(control, false)
        {

        }
        private DOMVar(NativeWebBrowser control, bool noCreate = false) : base(control)
        {
